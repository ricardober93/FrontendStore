...
import { Avatar, InputAdornment, FormControl, Button, Select, MenuItem, Grid, TextField, InputLabel, Card, Typography, FormHelperText } from '@material-ui/core'
        ...
        <Grid container>
            <Grid
                ...
                <Grid item xs={12} sm={4}>
                    ...
                    >{messages.logo_change_button}</Button>
                    <ModalChangeLogo
                        logoMode={logoMode}
                        titleLogo={titleLogo}
                    ...
                    <Card className={classes.previewCard}
                        ...
                        <Grid container spacing={2}>
                            <Grid className={classes.previewLogo} item xs={2}>
                                {!logoDisabled ?
                                    <Avatar src={logo_preview.logo} variant={logoMode} className={classes.previewLogoImg} />
                                    : null}
                            </Grid>
                            <Grid item xs={8}>
                                <Typography
