...
import { Button, Dialog, Card, CardContent, Grid, Paper } from '@material-ui/core'
                ...
                <Grid className={classes.control} item xs={12}>
                        ...
                        <CardContent>
                            <Grid className={classes.control} item xs={12}>
                                ...
                                <Grid align="center" xs={12} >
                                    <br/><br/>
                                    <Button align="center" variant="contained" color="primary" onClick={openColorPrimary} >{messages.color_picker_change}</Button>
                                </Grid>
                            </Grid>
                    ...
                    <Grid container direction="column" className={classes.button}>
                        <Grid align="right" item>
                            <br/><br/><br/>
                            <Button startIcon={<SaveIcon />} variant="contained" onClick={onClick} color="primary">
