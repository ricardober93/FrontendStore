...
export const getCustomization = () => {
  return new Promise((resolve, reject) => {
    axios
      .get(process.env.REACT_APP_BACK_URL + "/api/customization")
      .then((response) => {
...
export const updateColors = (colorPicker) => {
  ...
  return new Promise((resolve, reject) => {
    axios
      .put(process.env.REACT_APP_BACK_URL + "/api/colors", data, {
...
export const updateLanguage = (language) => {
  ...
  return new Promise((resolve, reject) => {
    axios
      .put(process.env.REACT_APP_BACK_URL + "/api/language", data, {
        headers: { authorization: "Bearer " + localStorage.getItem("token") },
      })
      .then((response) => {
        resolve(response.data);
...
export const updateLogoPreview = (avatar) => {
  return new Promise((resolve, reject) => {
    axios
      .post(process.env.REACT_APP_BACK_URL + "/api/logo-preview", avatar, {
        headers: {
...
export const updateLogo = (avatar) => {
  return new Promise((resolve, reject) => {
    axios
      .post(process.env.REACT_APP_BACK_URL + "/api/logo", avatar, {
        headers: {
          authorization: "Bearer " + localStorage.getItem("token"),
          "content-type": "multipart/form-data",
        },
